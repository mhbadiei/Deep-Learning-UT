...
class noteRecognizer:
    ...
    def processing(self, filePath):
        ...
        return ifft([data_[i:i+self.dataFrameLength, ] for i in range(self.compressionLength - self.dataFrameLength)])
...
if __name__ == "__main__" :
    ...
    # Time frame should be in unit of mili second     
    model = noteRecognizer(compressionLength = 200, timeFrame=300, notesLength = 6, instrumentLength = 6)
