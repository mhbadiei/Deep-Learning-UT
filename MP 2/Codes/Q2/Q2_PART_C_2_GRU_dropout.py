...
class noteRecognizer:
    ...
    def train_(self):
        self.model.add(tf.keras.layers.GRU(128, input_shape=(1, self.dataFrameLength), activation="relu"))
...
if __name__ == "__main__" :
    ...
    # Time frame should be in unit of mili second     
    model = noteRecognizer(compressionLength = 400, timeFrame=250, notesLength = 30, instrumentLength = 30)
